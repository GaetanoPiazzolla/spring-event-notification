...
import gae.piaz.pattern.events.publisher.TransactionSynchronizationAspect;
...
@TestPropertySource(properties = "events.notification-enabled=true")
@ActiveProfiles("test")
class TransactionSyncrhonizationAspectTest {

    @Autowired private MockMvc mockMvc;

    @Mock private ApplicationEventPublisher springEventPublisher;

    @Autowired private TransactionSynchronizationAspect transactionSynchronizationAspect;

    @BeforeEach
    void setUp() {
        ReflectionTestUtils.setField(
                transactionSynchronizationAspect, "springEventPublisher", springEventPublisher);
    }
